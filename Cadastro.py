...
def main (page:Page):
    ...
    #Tela de login
    titulolog = Text("Login", color="black", size=50, weight= FontWeight.W_900 )
    ...
    #Tela de cadastro
    titulocad = Text("Cadastro", color="black", size = 50, weight= FontWeight.W_900)
    ...
    btncad = FilledButton(text="Cadastrar", style = ButtonStyle(bgcolor = '#FF0000', color = '#FFFFFF'),on_click= lambda e: entrar(e))
